 ...
 * generated in the wsplugin.domibus.eu package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetStatusRequest_QNAME = new QName("http://eu.domibus.wsplugin/", "getStatusRequest");
    private final static QName _StatusRequest_QNAME = new QName("http://eu.domibus.wsplugin/", "statusRequest");
    private final static QName _GetStatusResponse_QNAME = new QName("http://eu.domibus.wsplugin/", "getStatusResponse");
    private final static QName _GetErrorsRequest_QNAME = new QName("http://eu.domibus.wsplugin/", "getErrorsRequest");
    private final static QName _GetMessageErrorsResponse_QNAME = new QName("http://eu.domibus.wsplugin/", "getMessageErrorsResponse");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: wsplugin.domibus.eu
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://eu.domibus.wsplugin/", name = "getStatusRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://eu.domibus.wsplugin/", name = "statusRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://eu.domibus.wsplugin/", name = "getStatusResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://eu.domibus.wsplugin/", name = "getErrorsRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://eu.domibus.wsplugin/", name = "getMessageErrorsResponse")
