...
@XmlType(name = "NotificationType", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:rim:4.0", propOrder = {
    "event"
})
    ...
    extends RegistryObjectType
{
    ...
    @XmlElement(name = "Event", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:rim:4.0", required = true)
