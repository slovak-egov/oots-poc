...
@XmlType(name = "InternationalStringType", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:rim:4.0", propOrder = {
    "localizedString"
})
public class InternationalStringType {

    @XmlElement(name = "LocalizedString", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:rim:4.0")
