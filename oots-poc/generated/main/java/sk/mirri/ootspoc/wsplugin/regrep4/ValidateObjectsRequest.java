...
@XmlRootElement(name = "ValidateObjectsRequest", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:spi:4.0")
public class ValidateObjectsRequest
    extends RegistryRequestType
{

    @XmlElement(name = "Query", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:spi:4.0")
    ...
    @XmlElement(name = "OriginalObjects", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:spi:4.0")
