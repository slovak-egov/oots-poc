...
@XmlType(name = "SubscriptionType", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:rim:4.0", propOrder = {
    "deliveryInfo",
    "selector"
})
    ...
    extends RegistryObjectType
{
    ...
    @XmlElement(name = "DeliveryInfo", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:rim:4.0")
    protected List<DeliveryInfoType> deliveryInfo;
    @XmlElement(name = "Selector", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:rim:4.0", required = true)
