...
@XmlType(name = "AuditableEventType", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:rim:4.0", propOrder = {
    "action"
})
    ...
    extends RegistryObjectType
{
    ...
    @XmlElement(name = "Action", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:rim:4.0", required = true)
