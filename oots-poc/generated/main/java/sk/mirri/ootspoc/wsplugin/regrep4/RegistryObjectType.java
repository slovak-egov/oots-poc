...
@XmlType(name = "RegistryObjectType", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:rim:4.0", propOrder = {
    "name",
    "description",
    "versionInfo",
    "classification",
    ...
    extends IdentifiableType
{
    ...
    @XmlElement(name = "Name", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:rim:4.0")
    ...
    @XmlElement(name = "VersionInfo", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:rim:4.0")
    protected VersionInfoType versionInfo;
    @XmlElement(name = "Classification", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:rim:4.0")
    protected List<ClassificationType> classification;
    @XmlElement(name = "ExternalIdentifier", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:rim:4.0")
    protected List<ExternalIdentifierType> externalIdentifier;
    @XmlElement(name = "ExternalLink", namespace = "urn:oasis:names:tc:ebxml-regrep:xsd:rim:4.0")
